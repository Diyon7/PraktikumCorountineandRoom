package com.example.corountineandroom
...
import com.example.corountineandroom.catatan.Note
...
class NoteAdapter : ListAdapter<Note, NoteAdapter.NoteHolder>(DIFF_CALLBACK) {
        ...
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Note>() {
            ...
            override fun areContentsTheSame(oldItem: Note, newItem: Note): Boolean {
                return oldItem.title == newItem.title && oldItem.description == newItem.description
                        && oldItem.priority == newItem.priority && oldItem.telephone == newItem.telephone
            }
        }
    }
    ...
    override fun onBindViewHolder(holder: NoteHolder, position: Int) {
        ...
        holder.textViewTelephone.text = currentNote.telephone
    }
    ...
    inner class NoteHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var textViewTelephone: TextView = itemView.text_view_telepon
    }
