...
class AddEditNoteActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val EXTRA_TELEPON = "com.piusanggoro.notesapp.EXTRA_TELEPON"
    }
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            texttelepon.setText(intent.getStringExtra(EXTRA_TELEPON))
    ...
    private fun saveNote() {
        ...
        val data = Intent().apply {
            ...
            putExtra(EXTRA_TELEPON, texttelepon.text.toString())
